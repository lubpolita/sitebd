...
<html lang="pt-br">
    ...
    <div class="container">
    <h2 class="text-uppercase text-white font-weight-bold text-center">Listar Turmas</h2>
    <table class="table">
        <thead class="table-hover">
            ...
            <th scope="col"class="text-white font-weight-bold text-center">CPF Professor</th>
            <th scope="col"class="text-white font-weight-bold text-center">ID da modalidade</th>

            </tr>
        </thead>
    <tbody>
    <?php
    $search = "SELECT * FROM turma"; //realizando pesquisa
    ...
    while($row = mysqli_fetch_assoc($searchResult)){
            ...
            <td class="text-white font-weight-bold text-center"> <?php echo $row['CPFProf']; ?></td>
