...
<html lang="pt-br">
    ...
    <div class="container">
    <h2 class="text-uppercase text-white font-weight-bold text-center">Listar Funcionários</h2>
    <table class="table">
        <thead class="table-hover">
            ...
            <th scope="col"class="text-white font-weight-bold text-center">Salario</th>
    ...
    <tbody>
    <?php
    $searchFunc = "SELECT * FROM funcionario"; //realizando pesquisa
    $searchResultFunc = mysqli_query($conn, $searchFunc);           //resultados da pesq    
