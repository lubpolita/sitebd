...
<html lang="pt-br">
    ...
    <div class="container">
    <h2 class="text-uppercase text-white font-weight-bold text-center">Listar Inscrições</h2>
    <table class="table">
        <thead class="table-hover">
             <tr>
            <th scope="col" class="text-white font-weight-bold text-center">CPF Aluno</th>
    ...
    <tbody>
    <?php
    $search = "SELECT * FROM inscreve"; //realizando pesquisa
    ...
    while($row = mysqli_fetch_assoc($searchResult)){
            ...
            ?>
            <tr>
            <th class="text-white font-weight-bold text-center"> <?php echo $row['CPFAluno']; ?></th>
            <td class="text-white font-weight-bold text-center"> <?php echo $row['idTurma']; ?></td>
